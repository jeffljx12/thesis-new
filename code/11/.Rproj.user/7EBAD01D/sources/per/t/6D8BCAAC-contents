...
# build model
d2k2_model = function(time,beta0,beta1,beta2,beta3,beta4,beta5,
                      ra1_i,ra2_i,ra3_i,tau1,tau2,tau3,
  ...
  return( ra1_i + beta0 + beta1*time_i + beta2*time_i^2 +
          ...
          + beta5*ifelse(time_i-tau3>0,(time_i-tau3)^2,0)
  )
