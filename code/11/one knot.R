...
# build model
d2k2_model = function(time,beta0,beta1,beta2,beta3,
  ...
  return( ra1_i + beta0 + beta1*time_i + beta2*time_i^2 +
            beta3*ifelse(time_i-tau1>0,(time_i-tau1)^2,0) 
  )
...
# almost true value
start.true =c(beta0 = 9, beta1 =4,beta2 = 2,beta3 = 0.8,
