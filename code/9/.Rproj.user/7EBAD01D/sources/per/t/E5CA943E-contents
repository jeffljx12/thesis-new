...
splineCurve = function(t,intercept.x = 0,intercept.y=0,speed=0,tau,degree=3,
                        beta,gamma, sd=1,errorTerm =F){
...
sim.d3k2 = splineCurve(1:20,intercept.x = 0,intercept.y=0,speed=0,
                       tau=c(7.3,14.6),degree=3,beta=c(20,10,7,0.7),
                       gamma=c(0.5,-1),errorTerm=F
                       )
